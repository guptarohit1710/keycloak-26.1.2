...
<head>
    ...
    <title>${msg("infinxAccountManagementTitle")}</title>
    ...
    <header class="navbar navbar-default navbar-pf navbar-main header">
        <nav class="navbar" role="navigation">
            <div class="navbar-header">
                <div class="container">                    
					<span class="custom-span-logo-1">INFIN</span><span class="custom-span-logo-2">X</span>
                </div>
            </div>
            <div class="navbar-collapse navbar-collapse-1">
                <div class="container">
                    <ul class="nav navbar-nav navbar-utility">
                        ...
                        <li><a href="${url.logoutUrl}" class="padding-top-6">${msg("doSignOut")}</a></li>
                    </ul>
                </div>
            </div>
        </nav>
